...
class PokemonImageProvider extends ChangeNotifier {
  ...
  void eitherFailureOrPokemonImage({required PokemonEntity pokemoneEntity}) async {
    ...
    String  imageUrl = isShiny ? pokemoneEntity.sprites.other.officialArtwork.frontShiny : pokemoneEntity.sprites.other.officialArtwork.frontDefault;
